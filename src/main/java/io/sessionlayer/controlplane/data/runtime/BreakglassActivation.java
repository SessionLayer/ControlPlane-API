...
public record BreakglassActivation(@Id UUID id, String principal, String reason, String alertRef,
		...
		Instant reviewedAt, @Version Long version, @CreatedDate Instant createdAt,
		@LastModifiedDate Instant updatedAt) {

	public static BreakglassActivation create(String principal, String reason, String alertRef, UUID breakglassPolicyId,
			String breakglassPolicyName, String reviewStatus, Instant activatedAt) {
		return new BreakglassActivation(Uuids.v7(), principal, reason, alertRef, breakglassPolicyId,
				breakglassPolicyName, reviewStatus, null, activatedAt, null, null, null, null);
	}
}
